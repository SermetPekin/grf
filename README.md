...
[![Build Status](https://dev.azure.com/grf-labs/grf/_apis/build/status/grf-labs.grf?branchName=master)](https://dev.azure.com/grf-labs/grf/_build/latest?definitionId=2&branchName=master) [![GH - C++ Tests (except NaN and characterization)](https://github.com/SermetPekin/grf/actions/workflows/cpp-core-tests.yml/badge.svg)](https://github.com/SermetPekin/grf/actions/workflows/cpp-core-tests.yml)
